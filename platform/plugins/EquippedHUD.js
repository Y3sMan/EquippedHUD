...
function SetWidgetValues() {
    (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.SetIntValue)(null, key + 'left', left_text);
    (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.SetIntValue)(null, key + 'right', right_text);
    (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.SetIntValue)(null, key + 'shout', shout_text);
    (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.SetIntValue)(null, key + 'init', 1);
    SetEquipped();
}
function init() {
    var init = (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.GetIntValue)(null, key + 'init', 0);
    // if ( init == 0 ) {
    CreateWidgets();
    SetWidgetValues();
    // }
...
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.once)('skyrimLoaded', function () {
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.printConsole)('skryimLoaded');
    (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.SetIntValue)(null, key + 'init', 0);
    CreateWidgets();
});
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.once)('scriptInit', function () {
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.printConsole)('scriptinit');
    init();
});
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.once)('loadGame', function () {
...
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.once)('update', function () {
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.printConsole)('init');
    init();
});
...
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.on)('actionBeginDraw', function () {
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.printConsole)('begindraw');
...
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.on)('actionBeginSheathe', function () {
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.printConsole)('beginsheathe');
    skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.browser.setVisible(true);
});
...
function GetWidget(slot) {
    slot = slot.toLowerCase();
    if (slot != 'left' || slot != 'right' || slot != 'shout') {
        return "".concat(slot, " is not a proper argument for GetWidget()");
    }
    if ((0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.GetIntValue)(null, key + slot, 0) == 0) {
        return "".concat(slot, " widget not created");
    }
    return (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.GetIntValue)(null, key + slot, 0);
}
