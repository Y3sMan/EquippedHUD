...
var init = skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.storage[plugin_init];
skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.storage[plugin_init] == false;
// let allowInit = storage[plugin_init] as boolean | false;
var WasInitialized = function () { return (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.GetIntValue)(null, plugin_init, 0); };
var MarkInitialized = function () { return (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.SetIntValue)(null, plugin_init, 1); };
var InitPlugin = function () {
    ...
    skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.storage[plugin_init] = true;
    MarkInitialized();
    init = 1;
...
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.on)('menuClose', function () { skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.browser.setVisible(true); fadein(); });
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.on)('actionEndDraw', function () {
    fadein();
});
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.on)('actionEndSheathe', function () {
    fadeout();
});
var fadeout = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                bfadeout = true;
                return [4 /*yield*/, skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.Utility.wait(3.0)];
            case 1:
                _a.sent();
                if (bfadeout) {
                    widgets = [skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.storage[key + 'left.'], skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.storage[key + 'right.'], skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.storage[key + 'shout.']];
                    // var widgets: number[]  = [ left_text, right_text, shout_text]
                    widgets.forEach(function (w) {
                        var c = (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.getTextColor)(w);
                        c[3] = 0;
                        (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.setTextColor)(w, c);
                    });
                }
                bfadeout = false;
                return [2 /*return*/];
...
function fadein() {
    ...
    bfadeout = false;
    // if ( !bfadeout ){
    var widgets = [skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.storage[key + 'left.'], skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.storage[key + 'right.'], skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.storage[key + 'shout.']];
    // var widgets: number[]  = [ left_text, right_text, shout_text]
    widgets.forEach(function (w) {
        var c = (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.getTextColor)(w);
        c[3] = 1;
...
(0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.on)('equip', function (e) {
    ...
    fadein();
    SetEquipped();
    if (!((_a = pl()) === null || _a === void 0 ? void 0 : _a.isWeaponDrawn())) {
        fadeout();
    }
});
...
function SetEquipped() {
    ...
    */
    ...
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.setTextString)(left_text, l_name);
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.setTextString)(right_text, r_name);
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.setTextString)(shout_text, s_name);
}
